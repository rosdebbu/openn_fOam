"""
Ghia et al. (1982) Standard Reference Data for 2D Lid-Driven Cavity Flow
Citation:
...
# Vertical centerline (x = 0.5): u-velocity vs y
GHIA_Y = np.array([
...
# Horizontal centerline (y = 0.5): v-velocity vs x
GHIA_X = np.array([
...
GHIA_V_RE400 = np.array([
    0.00000, -0.12146, -0.15663, -0.19254, -0.22847, -0.38598, -0.44993, -0.38598,
    0.05186, 0.30203, 0.30872, 0.30562, 0.22965, 0.20199, 0.18360, 0.16367, 0.00000
])